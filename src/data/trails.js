...
export const trails = [
  createTrail({
    ...
    description: 'Aprenda a pensar como um programador antes de escrever código. Desenvolva raciocínio lógico com algoritmos, variáveis, condicionais, laços de repetição e vetores.',
    instructor: 'Prof. Gustavo Guanabara (Curso em Vídeo)',
    icon: 'cpu',
    color: 'brand',
    order: 0,
    difficulty: 'beginner',
    estimatedHours: 6,
    modules: [
      'logica-mod-introducao',
      'logica-mod-algoritmos',
      'logica-mod-variaveis',
      'logica-mod-condicionais',
      'logica-mod-repeticao',
      'logica-mod-vetores',
      'logica-mod-exercicios',
    ],
    status: 'available',
    requiredTrail: null,
    xp: 500,
