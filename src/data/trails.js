...
export const trails = [
  ...
  createTrail({
    ...
    difficulty: 'beginner',
    estimatedHours: 4,
    modules: ['html-intro-module', 'html-structure-module', 'html-tags-module', 'html-texts-module', 'html-links-module', 'html-images-module', 'html-lists-module', 'html-tables-module', 'html-forms-module', 'html-semantic-module', 'html-seo-module', 'html-a11y-module', 'html-moderno-module', 'html-final-project', 'html-vid-intro', 'html-vid-fundamentals', 'html-vid-basics', 'html-vid-images', 'html-vid-texts', 'html-vid-lists', 'html-vid-links', 'html-vid-media'],
    status: 'available',
  ...
  createTrail({
    ...
    difficulty: 'beginner',
    estimatedHours: 4,
    modules: ['css-fundamentals', 'css-layout', 'css-advanced', 'css-vid-intro'],
    status: 'building',
