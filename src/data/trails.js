...
export const trails = [
  createTrail({
    ...
    description: 'Aprenda a pensar como um programador antes de escrever código. Desenvolva raciocínio lógico com algoritmos, variáveis, operadores, condicionais, laços de repetição, funções e projetos práticos.',
    instructor: 'Cataline',
    icon: 'code2',
    color: 'brand',
    order: 0,
